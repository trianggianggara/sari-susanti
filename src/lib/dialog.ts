 ...
 * Can be used anywhere in the app, not just admin pages.
 */

export interface ConfirmDialogOptions {
  /** Dialog heading. Default: 'Konfirmasi' */
  title?: string;
  /** Label for the destructive button. Default: 'Ya' */
  confirmLabel?: string;
}
  ...
  el.innerHTML = `
    <div class="confirm-dialog__content">
      ...
      <div class="confirm-dialog__actions">
        ...
        <button class="confirm-dialog__confirm" id="confirm-ok-btn" type="button">Ya</button>
      </div>
    </div>
  `;
